...
import 'package:pokemon_by_weather/src/domain/use_cases/pokemon/impl/get_pokemon_by_type_use_case_impl.dart';
...
import 'package:pokemon_by_weather/src/domain/use_cases/pokemon/impl/get_two_pokemons_by_type_use_case_impl.dart';
...
class AppDI {
  ...
  static void _configureUseCases() {
    ...
    di.registerLazySingleton<GetPokemonByTypeUseCase>(
      () => GetPokemonByTypeUseCaseImpl(repository: di.get()),
    );

    di.registerLazySingleton<GetTwoPokemonsByTypeUseCase>(
      () => GetTwoPokemonsByTypeUseCaseImpl(repository: di.get()),
    );
  }
